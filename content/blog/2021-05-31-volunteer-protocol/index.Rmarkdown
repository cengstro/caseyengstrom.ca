...
*Participants must complete the [liability waiver](https://form.jotform.com/211555732971055). You only need do this once. Once we have processed your form we can activate your Gaia Premium account.*
...
*Visit the [Gaia GPS website](https://www.gaiagps.com/). If this is your first time, click 'Sign Up For Free', and use the same email you used for the [liability waiver/sign up](https://form.jotform.com/211555732971055). Note: it may take a few days after you sign up for us to activate your free [Gaia Premium](https://www.gaiagps.com/premium/) subscription.*
...
Upon return, visit [gaiagps.com](https://www.gaiagps.com/) and click a few points to ensure that your data was properly sync'd. If not, check the sync settings in your phone app. See step 2F.  
